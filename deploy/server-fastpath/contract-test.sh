...
grep -Fq 'export FRONTEND_ALLOWED_ORIGINS=http://127.0.0.1:3000,http://localhost:5173,http://127.0.0.1:5173' "$FAST_DIR/local-browser-acceptance.sh"
grep -Fq 'export SANCTUM_STATEFUL_DOMAINS=127.0.0.1:3000,localhost:5173,127.0.0.1:5173' "$FAST_DIR/local-browser-acceptance.sh"
