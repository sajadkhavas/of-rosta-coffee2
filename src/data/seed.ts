...
export const faqs: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "روستری مورد نظر را انتخاب کنید، محصول را با وزن و نوع آسیاب دلخواه سفارش دهید. روستری پس از ثبت سفارش قهوه را آماده و ارسال می‌کند.",
  },
  {
    q: "تفاوت آسیاب اسپرسو و فرنچ‌پرس چیست؟",
    a: "آسیاب اسپرسو بسیار ریز است و برای دستگاه اسپرسو استفاده می‌شود. آسیاب فرنچ‌پرس درشت‌تر است و برای دم‌آوری ۴ دقیقه‌ای مناسب است.",
  },
  {
