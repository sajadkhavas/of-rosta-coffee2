  ...
  head: ({ loaderData }) => ({
    meta: [
      { title: "روستری‌های ایران | خرید مستقیم دانه قهوه | رستا" },
      {
        name: "description",
        content:
          "کشف روستری‌های تأییدشده ایران و مشاهده دانه‌های تازه‌رست، موجودی و زمان آماده‌سازی زنده.",
      },
    ...
    <>
      ...
      <main className="mx-auto max-w-6xl px-4 py-8">
        ...
        <header className="mt-4">
          ...
          <h1 className="mt-2 text-3xl font-bold sm:text-4xl">روستری‌های ایران</h1>
          <p className="mt-3 max-w-2xl text-sm leading-7 text-[color:var(--light)]">
            پروفایل، شهر، امتیاز و زمان آماده‌سازی فقط از API رسمی روستری‌های تأییدشده نمایش داده
            می‌شود.
          </p>
        </header>
        {query.isPending ? (
          ...
          <section className="mt-10 rounded-2xl border border-dashed border-[color:var(--mid)] p-10 text-center">
            ...
            <p className="mt-2 text-sm text-[color:var(--light)]">
              پس از تأیید ادمین، روستری‌های فعال اینجا نمایش داده می‌شوند.
            </p>
          </section>
        ) : (
          <>
            ...
            {lastPage > 1 ? (
              <nav
                ...
                aria-label="صفحه‌بندی روستری‌ها"
              >
                <button
                  type="button"
