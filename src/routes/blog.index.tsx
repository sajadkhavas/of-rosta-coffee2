  ...
  head: () => ({
    meta: [
      { title: "مجله رستا — راهنمای قهوه، دم‌آوری و رست" },
      {
        name: "description",
        content:
          "مقالات تخصصی درباره قهوه، روش‌های دم‌آوری، تازگی دانه و رازهای رست تازه در مجله رستا.",
      },
      ...
      <main className="mx-auto max-w-6xl px-4 py-10">
        ...
        <header className="mb-10">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-[color:var(--light)]">
            مقاله‌های تخصصی درباره تازگی قهوه، روش‌های دم‌آوری و آسیاب خانگی دانه کامل.
          </p>
        </header>
