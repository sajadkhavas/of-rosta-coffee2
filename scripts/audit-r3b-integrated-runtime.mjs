...
const required = [
  ...
  [
    "workflow",
    "rosta:acceptance-fixtures --json",
    "Integrated CI must seed the R3A fixture contract.",
  ],
  [
    "workflow",
  ...
  [
    ...
    "Production payment activation must remain disabled.",
  ],
  ...
  [
    ...
    "Only the generated route tree may be restored after evidence capture.",
  ],
  ...
  [
    ...
    "Runtime acceptance must reject unauthenticated protected access.",
  ],
  [
    "runtime",
    "ssr_product_detail",
    "Runtime acceptance must prove an API-backed SSR detail route.",
  ],
  [
    "runtime",
    "ROSTA_R3B_INTEGRATED_RUNTIME_COMPLETE",
    "Runtime acceptance must emit the R3B marker.",
  ],
...
await writeFile("r3b-integration-audit.json", `${JSON.stringify(report, null, 2)}\n`, "utf8");
