 ...
 * @property-read Collection<int, CommissionPolicyRule> $rules
 */
final class CommissionPolicy extends Model
{
    ...
    /** @return HasMany<CommissionPolicyRule, $this> */
    public function rules(): HasMany
    {
        return $this->hasMany(CommissionPolicyRule::class)->orderBy('priority')->orderBy('code');
    }
